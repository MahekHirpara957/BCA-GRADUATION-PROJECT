...
<div class="hero-wrap">
    ...
    <div class="stat-row">
        <div class="stat-box"><div class="s-val">6+</div><div class="s-lbl">Modules</div></div>
        <div class="stat-box"><div class="s-val">4</div><div class="s-lbl">ML Models</div></div>
        <div class="stat-box"><div class="s-val">20</div><div class="s-lbl">Credits</div></div>
        <div class="stat-box"><div class="s-val">1200</div><div class="s-lbl">Marks</div></div>
        <div class="stat-box"><div class="s-val">BCA</div><div class="s-lbl">Level</div></div>
    </div>
</div>
""", unsafe_allow_html=True)
...
with c1:
    st.markdown("""
    <div class="bz-card">
        <div class="bz-section-title">🎓 Academic Info</div>
        <table style="width:100%;border-collapse:collapse;">
            <tr><td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#64748B;font-size:.82rem;font-weight:600;">Project Title</td>
                <td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#1E293B;font-size:.82rem;">BuzNet – Business Intelligence System</td></tr>
            <tr><td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#64748B;font-size:.82rem;font-weight:600;">Project Type</td>
                <td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#1E293B;font-size:.82rem;">BCA Major Final Year Project</td></tr>
            <tr><td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#64748B;font-size:.82rem;font-weight:600;">Credits</td>
                <td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#2563EB;font-size:.82rem;font-weight:700;">20 Credits</td></tr>
            <tr><td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#64748B;font-size:.82rem;font-weight:600;">Total Marks</td>
                <td style="padding:.5rem .4rem;border-bottom:1px solid #E2E8F0;color:#2563EB;font-size:.82rem;font-weight:700;">1200 Marks</td></tr>
            <tr><td style="padding:.5rem .4rem;color:#64748B;font-size:.82rem;font-weight:600;">Institution</td>
                <td style="padding:.5rem .4rem;color:#1E293B;font-size:.82rem;">CMPICA, CHARUSAT – Changa</td></tr>
        </table>
    </div>""", unsafe_allow_html=True)
...
with c2:
    st.markdown("""
    <div class="bz-card">
        <div class="bz-section-title">✨ Key Features</div>
        <div style="display:flex;flex-direction:column;gap:0.55rem;">
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Multi-model ML — XGBoost, Random Forest, Decision Tree & Linear Regression</span>
            </div>
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Industry-level Dashboard with KPIs, heatmap, Top/Bottom product analysis</span>
            </div>
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Inline Edit & Delete records from Data Intake and Search pages</span>
            </div>
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Auto-generated business insights + downloadable PDF reports</span>
            </div>
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Advanced search with date/product/revenue filters + Excel & CSV export</span>
            </div>
            <div style="display:flex;align-items:flex-start;gap:0.6rem;">
                <span style="color:#10B981;font-size:0.9rem;margin-top:0.1rem;flex-shrink:0;">✅</span>
                <span style="color:#374151;font-size:0.82rem;line-height:1.55;">Premium Blue & White SaaS UI — modern, minimal, professional</span>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
...
st.markdown("""
<div class="bz-footer">
    <div style="font-size:1.3rem;font-weight:800;margin-bottom:0.3rem;">📊 BuzNet v4.0 — Major Project</div>
    ...
    <div style="font-size:0.78rem;opacity:0.7;">
        BCA Final Year Major Project &nbsp;•&nbsp; CMPICA, CHARUSAT &nbsp;•&nbsp; 20 Credits &nbsp;•&nbsp; 1200 Marks
    </div>
</div>
""", unsafe_allow_html=True)
